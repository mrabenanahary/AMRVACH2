...
!============================================================================
subroutine setmetric_initialize_schwarzschild_spherical(pm)
  include 'amrvacdef.f'
...
end subroutine setmetric_initialize_schwarzschild_spherical
!=============================================================================
subroutine setmetric_spacetime_schwarzschild_spherical(ixI^L,ixO^L,x,pm)
 include 'amrvacdef.f'
 ...
 call setmetric_lapse_schwarzschild_spherical(pm%alfa,pm%cell_center)
 call setmetric_space_schwarzschild_spherical(pm%alfa,pm%elemsp,pm%cell_center)

 contains
!===============================================================================
!-----------------------------------------------------------------------------
!============================================================================
 subroutine setmetric_lapse_schwarzschild_spherical(palpha,drv_needed)
...
!------------------------------------------------------------
 ...
 end subroutine setmetric_lapse_schwarzschild_spherical


!============================================================================

 subroutine setmetric_space_schwarzschild_spherical(palpha,pmc,drv_needed)
...
!-----------------------------------------------------------------------------
 ...
 end subroutine setmetric_space_schwarzschild_spherical
! ============================================================================
end subroutine setmetric_spacetime_schwarzschild_spherical
