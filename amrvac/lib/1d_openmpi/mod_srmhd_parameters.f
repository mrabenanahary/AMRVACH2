...
module mod_srmhd_parameters
  ...
  logical, public     :: boundary_divbfix(2*1)=.true.

  !> To skip * layer of ghost cells during divB=0 fix for boundary
  integer, public     :: boundary_divbfix_skip(2*1)=0
...
type phys_srmhd_parameters
  ...
  !> To control divB=0 fix for boundary
  logical, public     :: boundary_divbfix(2*1)

  !> To skip * layer of ghost cells during divB=0 fix for boundary
  integer, public     :: boundary_divbfix_skip(2*1)
