  ...
  subroutine read_par_files()
    ...
    namelist /meshlist/ refine_max_level,nbufferx1,refine_threshold,&
       derefine_ratio, refine_criterion, stretched_grid, stretched_dim,&
        ...
        amr_wavefilter,max_blocks,block_nx1,domain_nx1,iprob,xprobmin1,&
       xprobmax1, w_refine_weight, prolongprimitive,coarsenprimitive,&
...
107    close(unitpar)
    ...
    box_limit(1,1)=xprobmin1;
    box_limit(2,1)=xprobmax1;
