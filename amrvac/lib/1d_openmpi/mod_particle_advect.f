      ...
      if(ipe_particle == mype) then
        ...
        do idir=1,ndir
          call interpolate_var(igrid,ixGlo1,ixGhi1,ixMlo1,ixMhi1,&
             w(ixGlo1:ixGhi1,iw_mom(idir)),pw(igrid)%x,x(:,n),v(idir,n))
        end do
  ...
  subroutine advect_fill_gridvars
    ...
    do iigrid=1,igridstail; igrid=igrids(iigrid);
      ...
      if(time_advance) then
        ...
        w(ixGlo1:ixGhi1,1:nw) = pw(igrid)%wold(ixGlo1:ixGhi1,1:nw)
        call phys_to_primitive(ixGlo1,ixGhi1,ixGlo1,ixGhi1,w,pw(igrid)%x)
  ...
  subroutine get_vec_advect(igrid,x,tloc,var,ibeg,iend)
    ...
    if(.not.time_advance) then
      do ivar=ibeg,iend
        iloc = ivar-ibeg+1
        call interpolate_var(igrid,ixGlo1,ixGhi1,ixMlo1,ixMhi1,&
           gridvars(igrid)%w(ixGlo1:ixGhi1,ivar),pw(igrid)%x(ixGlo1:ixGhi1,&
           1:ndim),x,var(iloc))
      end do
    else
      ...
      do ivar=ibeg,iend
        iloc = ivar-ibeg+1
        call interpolate_var(igrid,ixGlo1,ixGhi1,ixMlo1,ixMhi1,&
           gridvars(igrid)%wold(ixGlo1:ixGhi1,ivar),pw(igrid)%x(ixGlo1:ixGhi1,&
           1:ndim),x,e1(iloc))
        call interpolate_var(igrid,ixGlo1,ixGhi1,ixMlo1,ixMhi1,&
           gridvars(igrid)%w(ixGlo1:ixGhi1,ivar),pw(igrid)%x(ixGlo1:ixGhi1,&
           1:ndim),x,e2(iloc))
