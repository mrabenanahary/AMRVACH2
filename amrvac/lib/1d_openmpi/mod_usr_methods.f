...
module mod_usr_methods
  ...
  abstract interface
     ...
     subroutine get_dt(w,ixImin1,ixImax1,ixOmin1,ixOmax1,qt,dtnew,dx1,x)
       use mod_global_parameters
       integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1
       double precision, intent(in)    :: dx1, qt
       double precision, intent(in)    :: x(ixImin1:ixImax1,1:ndim)
     ...
     subroutine set_B0(ixImin1,ixImax1,ixOmin1,ixOmax1,x,wB0,qt)
       use mod_global_parameters
       integer, intent(in)             :: ixImin1,ixImax1,ixOmin1,ixOmax1
       double precision, intent(in)    :: x(ixImin1:ixImax1,1:ndim)
       double precision, intent(in)    :: qt
     ...
     subroutine set_J0(ixImin1,ixImax1,ixOmin1,ixOmax1,x,wJ0,qt)
       use mod_global_parameters
       integer, intent(in)             :: ixImin1,ixImax1,ixOmin1,ixOmax1
       double precision, intent(in)    :: x(ixImin1:ixImax1,1:ndim)
       double precision, intent(in)    :: qt
