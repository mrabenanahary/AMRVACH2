...
module mod_physics
  ...
  abstract interface
     ...
     subroutine sub_convert(ixImin1,ixImax1, ixOmin1,ixOmax1, w, x)
       ...
       real(kind=dp)      , intent(in)    :: x(ixImin1:ixImax1, 1:1)
     ...
     subroutine sub_get_v_idim(w,x,ixImin1,ixImax1,ixOmin1,ixOmax1,idim,v)
       use mod_global_parameters

       integer, intent(in)           :: ixImin1,ixImax1, ixOmin1,ixOmax1, idim
       real(kind=dp)      , intent(in)  :: w(ixImin1:ixImax1,nw),&
           x(ixImin1:ixImax1,1:1)
       real(kind=dp)      , intent(out) :: v(ixImin1:ixImax1)
     ...
     subroutine sub_get_flux(wC, w, x, ixImin1,ixImax1, ixOmin1,ixOmax1, idim,&
       ...
       integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1,&
           idim
       real(kind=dp)      , intent(in)    :: wC(ixImin1:ixImax1, 1:nw)
     ...
     subroutine sub_add_source_geom(qdt, ixImin1,ixImax1, ixOmin1,ixOmax1, wCT,&
       ...
       use mod_global_parameters
       integer, intent(in)             :: ixImin1,ixImax1, ixOmin1,ixOmax1
       real(kind=dp)      , intent(in)    :: qdt, x(ixImin1:ixImax1, 1:1)
     ...
     subroutine sub_check_w(primitive, ixImin1,ixImax1, ixOmin1,ixOmax1, w,&
       ...
       integer, intent(in)          :: ixImin1,ixImax1, ixOmin1,ixOmax1
       real(kind=dp)      , intent(in) :: w(ixImin1:ixImax1,nw)
       integer, intent(inout)       :: w_flag(ixImin1:ixImax1)
     ...
     subroutine sub_angmomfix(fC,x,wnew,ixImin1,ixImax1,ixOmin1,ixOmax1,idim)
       ...
       integer, intent(in)                :: ixImin1,ixImax1, ixOmin1,ixOmax1
       real(kind=dp)      , intent(in)       :: x(ixImin1:ixImax1,1:ndim)
       real(kind=dp)      , intent(inout)    :: fC(ixImin1:ixImax1,1:nwflux,&
