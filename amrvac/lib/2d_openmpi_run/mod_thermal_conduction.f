...
111    close(unitpar)
  ...
  subroutine mhd_get_heatconduct(qd,tmp1,tmp2,ixImin1,ixImin2,ixImax1,ixImax2,&
    ...
    if(solve_internal_e) then
      ...
      tmp2(ixImin1:ixImax1,ixImin2:ixImax2) = 0.5d0 * (sum(w(ixImin1:ixImax1,&
         ixImin2:ixImax2,iw_mom(:))**2,dim=ndim+1)/w(ixImin1:ixImax1,&
  ...
  subroutine hd_get_heatconduct(qd,tmp1,tmp2,ixImin1,ixImin2,ixImax1,ixImax2,&
     ixOmin1,ixOmin2,ixOmax1,ixOmax2,w,x,qvec)
    use mod_global_parameters
    use mod_small_values, only: small_values_method
    ...
    ! conductivity at cell center
    qd(ixmin1:ixmax1,ixmin2:ixmax2)=tc_k_para*dsqrt(Te(ixmin1:ixmax1,&
       ixmin2:ixmax2))**5
    ke=0.d0
    do ix2=0,1
    do ix1=0,1
    ...
    do idims=1,ndim
      gradT(ixCmin1:ixCmax1,ixCmin2:ixCmax2,idims)=ke(ixCmin1:ixCmax1,&
         ixCmin2:ixCmax2)*qvec(ixCmin1:ixCmax1,ixCmin2:ixCmax2,idims)
    end do
