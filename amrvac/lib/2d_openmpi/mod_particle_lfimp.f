...
contains
  ...
  subroutine get_dervec(ix,igrid,x,tloc,vec,dir)
    ...
    if (.not.time_advance) then
      do idir=1,ndir
        call derinterpolate_var(igrid,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,&
           ixMlo2,ixMhi1,ixMhi2,gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
      ...
      do idir=1,ndir
        call derinterpolate_var(igrid,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,&
           ixMlo2,ixMhi1,ixMhi2,gridvars(igrid)%wold(ixGlo1:ixGhi1,&
           ixGlo2:ixGhi2,ix(idir)), pw(igrid)%x(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
           1:ndim),x,vec1(idir),dir)
        call derinterpolate_var(igrid,ixGlo1,ixGlo2,ixGhi1,ixGhi2,ixMlo1,&
           ixMlo2,ixMhi1,ixMhi2,gridvars(igrid)%w(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
           ix(idir)), pw(igrid)%x(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1:ndim),x,&
           vec2(idir),dir)
  ...
  subroutine derinterpolate_var(igrid,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2,gf,x,xloc,gfloc,dir)
    use mod_global_parameters
    ...
    if(dir .eq. 1) then
      xd1 = sign(1.0 / (x(ic21,ic12,1) - x(ic11,ic12,1)), xloc(1)-x(ic11,ic12,&
         1))
      ...
      xd2 = sign(1.0 / (x(ic11,ic22,2) - x(ic11,ic12,2)), xloc(2)-x(ic11,ic12,&
         2))
