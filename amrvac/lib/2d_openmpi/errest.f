...
double precision, dimension(ixMlo1:ixMhi1,ixMlo2:ixMhi2) :: numerator,&
    denominator, error
double precision, dimension(ixGlo1:ixGhi1,ixGlo2:ixGhi2) :: dpres, dm, dref,&
    tmp1
...
do iflag=1,nw+1
   ...
   do idims=1,ndim
      ...
      if (iflag<=nw) then
        if (logflag(iflag)) then
          dpres(ixmin1:ixmax1,ixmin2:ixmax2)=dlog10(pw(igrid)%w(jxmin1:jxmax1,&
          ...
          dpres(ixmin1:ixmax1,ixmin2:ixmax2)=pw(igrid)%w(jxmin1:jxmax1,&
        ...
        if (logflag(iflag)) then
          dpres(ixmin1:ixmax1,ixmin2:ixmax2)=dlog10(tmp1(jxmin1:jxmax1,&
          ...
          dpres(ixmin1:ixmax1,ixmin2:ixmax2)=tmp1(jxmin1:jxmax1,&
      ...
      numerator(ixMlo1:ixMhi1,ixMlo2:ixMhi2)=numerator+(dpres(ixMlo1:ixMhi1,&
         ixMlo2:ixMhi2)-dm(ixMlo1:ixMhi1,ixMlo2:ixMhi2))**2.0d0

      denominator(ixMlo1:ixMhi1,ixMlo2:ixMhi2)=denominator + &
         (dabs(dpres(ixMlo1:ixMhi1,ixMlo2:ixMhi2)) + dabs(dm(ixMlo1:ixMhi1,&
