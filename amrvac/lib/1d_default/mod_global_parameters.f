...
module mod_global_parameters
  ...
  real(kind=dp)     :: xprobmin1,xprobmax1
  ...
  real(kind=dp)   , dimension(:), allocatable :: dg1
...
contains
  ...
  pure subroutine cross_product(ixImin1,ixImax1,ixOmin1,ixOmax1,a,b,axb)
    ...
    real(kind=dp)   , intent(in) :: a(ixImin1:ixImax1,3), b(ixImin1:ixImax1,3)
    real(kind=dp)   , intent(out) :: axb(ixImin1:ixImax1,3)
    !-------------------------------------------------------------------------
