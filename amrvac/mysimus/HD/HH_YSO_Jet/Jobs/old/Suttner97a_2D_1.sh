#!/bin/bash
#SBATCH --job-name=Suttner97_2D_1
...
cd /data/$USER/Output
mkdir Suttner97_2D_1

cd $SCRATCH
srun --ntasks=$SLURM_JOB_NUM_NODES mkdir -p Output
srun --ntasks=$SLURM_JOB_NUM_NODES mkdir -p Output/Suttner97_2D
srun --ntasks=$SLURM_JOB_NUM_NODES cp $AMRVAC_DIR/mysimus/HD/HH_YSO_Jet/Parfiles/Article/mi_these/Suttner97_2D_1.par .
...
srun --ntasks=$SLURM_JOB_NUM_NODES more Suttner97_2D_1.par
mpiexec amrvac -i Suttner97_2D_1.par
srun --ntasks=$SLURM_JOB_NUM_NODES mv Output/Suttner97_2D/* /data/$USER/Output/Suttner97_2D_1/.
srun --ntasks=$SLURM_JOB_NUM_NODES cp $AMRVAC_DIR/mysimus/HD/HH_YSO_Jet/Jobs/slurm-${SLURM_JOBID}.out /data/$USER/Output/Suttner97_2D_1/.
cd ${SLURM_SUBMIT_DIR}
