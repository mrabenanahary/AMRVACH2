#!/bin/bash
#SBATCH --job-name=Lee2001_Fm_5e-7Msunperyr_res_max_6_Rxz_5e15cmx1v25e17cm_3deg_not_pulsed
...
srun --ntasks=$SLURM_JOB_NUM_NODES cp $AMRVAC_DIR/mysimus/HD/HH_YSO_Jet/Parfiles/Article/tests/Lee2001_Fm_5e-7Msunperyr_res_max_6_Rxz=5e15cmx1v25e17cm_3deg_not_pulsed.par .
#srun --ntasks=$SLURM_JOB_NUM_NODES cp /data/mrabenanahary/Output/Lee2001_res_max_6_R\=5e15cm_3deg/JetI_Lee_0009.dat Output/.
...
srun --ntasks=$SLURM_JOB_NUM_NODES more Lee2001_Fm_5e-7Msunperyr_res_max_6_Rxz=5e15cmx1v25e17cm_3deg_not_pulsed.par 
mpiexec amrvac -i Lee2001_Fm_5e-7Msunperyr_res_max_6_Rxz=5e15cmx1v25e17cm_3deg_not_pulsed.par 
