...
srun --ntasks=$SLURM_JOB_NUM_NODES mkdir -p Output/Shang06b
srun --ntasks=$SLURM_JOB_NUM_NODES cp $AMRVAC_DIR/mysimus/HD/HH_YSO_Jet/Parfiles/Article/Shang06/Shang06.par .
...
srun --ntasks=$SLURM_JOB_NUM_NODES more Shang06.par
mpiexec amrvac -i Shang06.par
srun --ntasks=$SLURM_JOB_NUM_NODES mv Output/Shang06b/Jet_Shang06_0100.dat /data/$USER/Output/Shang06b/.
srun --ntasks=$SLURM_JOB_NUM_NODES mv Output/Shang06b/* /data/$USER/Output/Shang06b/.
srun --ntasks=$SLURM_JOB_NUM_NODES cp $AMRVAC_DIR/mysimus/HD/HH_YSO_Jet/Jobs/slurm-${SLURM_JOBID}.out /data/$USER/Output/Shang06b/.
cd ${SLURM_SUBMIT_DIR}
