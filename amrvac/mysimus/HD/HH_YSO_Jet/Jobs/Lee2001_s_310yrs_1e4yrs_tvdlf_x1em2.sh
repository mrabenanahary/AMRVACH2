#!/bin/bash
#SBATCH --job-name=Lee2001_s_310yrs_1e4yrs_tvdlf_x1em2
#SBATCH --nodes=1 --ntasks-per-node=48
#SBATCH --time=7200
#SBATCH --partition=long
#SBATCH --mail-user=mialy.rabenanahary@gmail.com
#SBATCH --output=slurm-Lee2001_s_310yrs_1e4yrs_tvdlf_x1em2-%j.out
...
#srun --ntasks=$SLURM_JOB_NUM_NODES cp $AMRVAC_DIR/mysimus/HD/HH_YSO_Jet/Jet_CC_0100.dat .
