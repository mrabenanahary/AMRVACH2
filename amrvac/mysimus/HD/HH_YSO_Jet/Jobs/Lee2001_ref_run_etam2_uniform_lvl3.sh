#!/bin/bash
#SBATCH --job-name=Lee2001_ref_run_etam2_uniform_lvl3
#SBATCH --nodes=1 --ntasks-per-node=48
#SBATCH --time=7200
#SBATCH --partition=long
#SBATCH --mail-user=mialy.rabenanahary@gmail.com
#SBATCH --output=slurm-Lee2001_ref_run_etam2_uniform_lvl3-%j.out
...
srun --ntasks=$SLURM_JOB_NUM_NODES cp $AMRVAC_DIR/mysimus/HD/HH_YSO_Jet/Jet_CC_Shang06_0070.dat .
echo ${SLURM_JOBID}
echo $HOSTNAME
pwd
