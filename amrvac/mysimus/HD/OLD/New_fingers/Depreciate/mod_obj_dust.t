...
contains
  ...
  !> subroutine normalize setting for ISM
   subroutine usr_dust_normalize(self)
    ...
    self%myconfig%sizes            = self%myconfig%sizes         / unit_length
    self%myconfig%density          = self%myconfig%density       / unit_density
    self%myconfig%number_density   = self%myconfig%number_density/ unit_length**3.0_dp
    self%myconfig%grain_density    = self%myconfig%grain_density / unit_density
    ...
    self%myconfig%min_limit_abs    = self%myconfig%min_limit_abs / unit_density
