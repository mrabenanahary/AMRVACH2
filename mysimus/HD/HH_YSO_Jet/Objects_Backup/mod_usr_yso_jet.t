module mod_usr
  ...
  type usr_config
    ...
    real(kind=dp)     :: reset_flux_scheme_thresholdL1
...
contains
  ...
  subroutine usr_set_default_parameters
    ...
    usrconfig%reset_flux_scheme_thresholdL1 = 0.0_dp
...
!> subroutine read unit used in the code
  ...
  subroutine usr_normalise_parameters
   ...
   usrconfig%reset_flux_scheme_thresholdL1= &
                                  usrconfig%reset_flux_scheme_thresholdL1 &
    ...
    if(usrconfig%reset_flux_scheme_on)then
      ...
      case(1)
        if(phys_config%cool_saveL)then
          if(any(w(ixO^S,phys_ind%Lcool1_)>usrconfig%reset_flux_scheme_thresholdL1))then
