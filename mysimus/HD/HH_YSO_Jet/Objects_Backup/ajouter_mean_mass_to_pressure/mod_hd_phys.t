...
contains
  ...
  subroutine hd_physical_units
    ...
    if(unit_velocity<smalldouble) then
      ...
      unit_pressure= unit_numberdensity/phys_config%mean_mup*kB*unit_temperature
      unit_pressure= phys_config%mean_mass*unit_pressure
      unit_velocity=dsqrt(unit_pressure/unit_density)
      unit_time=unit_length/unit_velocity
    else
      unit_density=phys_config%mean_mass*mp*unit_numberdensity
      unit_pressure=unit_density*unit_velocity**2.0_dp
      unit_temperature=phys_config%mean_mup*unit_pressure/(unit_numberdensity*kB)
      unit_temperature=unit_temperature/phys_config%mean_mass
      unit_time=unit_length/unit_velocity
    end if
